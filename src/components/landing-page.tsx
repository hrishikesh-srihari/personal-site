...
export function LandingPage() {
  return (
    <div className= "flex flex-col min-h-screen bg-gray-100 dark:bg-gray-800 transition-all duration-500 ease-in-out">
      ...
      <main className="flex-1">
        ...
        >
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid items-start gap-10 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3 mt-8">
              <div className="group grid gap-6 transition-all duration-200 transform hover:scale-105 pr-3">
                <img
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-violet-400 dark:bg-violet-400 transition-all duration-500 ease-in-out">
        <p className="text-xs text-gray-800 dark:text-gray-800 font-space-grotesk transition-all duration-500 ease-in-out">
